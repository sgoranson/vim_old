...
"highlight Constant     term=NONE cterm=NONE ctermfg=220    ctermbg=NONE " yellow
"highlight Normal       term=NONE cterm=NONE ctermfg=117    ctermbg=NONE " light blue
highlight PreProc      term=NONE cterm=NONE ctermfg=10    ctermbg=NONE " light blue
highlight Function     term=NONE cterm=NONE ctermfg=117    ctermbg=NONE " purple
highlight Normal       term=NONE cterm=NONE ctermfg=4    ctermbg=NONE
highlight Comment      term=NONE cterm=NONE ctermfg=1    ctermbg=NONE
highlight Constant     term=NONE cterm=NONE ctermfg=7    ctermbg=NONE
highlight String       term=NONE cterm=NONE ctermfg=7    ctermbg=NONE
highlight Type         term=NONE cterm=NONE ctermfg=12    ctermbg=NONE
highlight Statement    term=NONE cterm=NONE ctermfg=10    ctermbg=NONE
highlight Identifier   term=NONE cterm=NONE ctermfg=12    ctermbg=NONE
highlight Search       term=NONE cterm=NONE ctermfg=233    ctermbg=6
highlight IncSearch    term=NONE cterm=NONE ctermfg=233    ctermbg=5
highlight NonText      term=NONE cterm=NONE ctermfg=239    ctermbg=NONE
...
highlight Todo         term=NONE cterm=NONE ctermfg=7    ctermbg=1
highlight VertSplit    term=NONE cterm=NONE ctermfg=0    ctermbg=NONE
highlight Visual       term=NONE cterm=NONE ctermfg=7    ctermbg=3
highlight DiffAdd      term=NONE cterm=NONE ctermfg=2    ctermbg=NONE
highlight DiffChange   term=NONE cterm=NONE ctermfg=3    ctermbg=NONE
highlight DiffDelete   term=NONE cterm=NONE ctermfg=1    ctermbg=NONE


" no bold
" highlight CursorLine   term=NONE cterm=NONE ctermfg=NONE ctermbg=0
" highlight ColorColumn  term=NONE cterm=NONE ctermfg=NONE ctermbg=3
" highlight Search       term=NONE cterm=NONE ctermfg=0    ctermbg=6
" highlight Comment      term=NONE cterm=NONE ctermfg=8    ctermbg=NONE
" highlight Constant     term=NONE cterm=NONE ctermfg=10    ctermbg=NONE
" highlight Cursor       term=NONE cterm=NONE ctermfg=11    ctermbg=NONE
" highlight DiffAdd      term=NONE cterm=NONE ctermfg=10    ctermbg=NONE
" highlight DiffChange   term=NONE cterm=NONE ctermfg=11    ctermbg=NONE
" highlight DiffDelete   term=NONE cterm=NONE ctermfg=9    ctermbg=NONE
" highlight FoldColumn   term=NONE cterm=NONE ctermfg=8    ctermbg=NONE
" highlight Folded       term=NONE cterm=NONE ctermfg=8    ctermbg=NONE
" highlight Function     term=NONE cterm=NONE ctermfg=15    ctermbg=NONE
" highlight Identifier   term=NONE cterm=NONE ctermfg=9    ctermbg=NONE
" highlight IncSearch    term=NONE cterm=NONE ctermfg=13    ctermbg=5
...
" highlight Pmenu        term=NONE cterm=NONE ctermfg=0    ctermbg=7
" highlight PreProc      term=NONE cterm=NONE ctermfg=11    ctermbg=NONE
" highlight Special      term=NONE cterm=NONE ctermfg=10    ctermbg=NONE
" highlight SpecialKey   term=NONE cterm=NONE ctermfg=2    ctermbg=NONE
" highlight Statement    term=NONE cterm=NONE ctermfg=15    ctermbg=NONE
" highlight StatusLine   term=NONE cterm=NONE ctermfg=8    ctermbg=NONE
" highlight StatusLineNC term=NONE cterm=NONE ctermfg=8    ctermbg=NONE
" highlight String       term=NONE cterm=NONE ctermfg=1    ctermbg=NONE
" highlight TabLineSel   term=NONE cterm=NONE ctermfg=15    ctermbg=NONE
" highlight Todo         term=NONE cterm=NONE ctermfg=15    ctermbg=9
" highlight Type         term=NONE cterm=NONE ctermfg=3    ctermbg=NONE
" highlight VertSplit    term=NONE cterm=NONE ctermfg=8    ctermbg=NONE
" highlight Visual       term=NONE cterm=NONE ctermfg=15    ctermbg=10
